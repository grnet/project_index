...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cronjob.user'
        db.add_column('index_cronjob', 'user',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cronjob.description'
        db.add_column('index_cronjob', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cronjob.user'
        db.delete_column('index_cronjob', 'user')

        # Deleting field 'Cronjob.description'
        db.delete_column('index_cronjob', 'description')
