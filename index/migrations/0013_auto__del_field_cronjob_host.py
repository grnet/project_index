...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cronjob.host'
        db.delete_column('index_cronjob', 'host_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Cronjob.host'
        raise RuntimeError("Cannot reverse this migration. 'Cronjob.host' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Cronjob.host'
        db.add_column('index_cronjob', 'host',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['index.Host']),
                      keep_default=False)
