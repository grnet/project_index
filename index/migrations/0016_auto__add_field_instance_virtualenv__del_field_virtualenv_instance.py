...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.virtualenv'
        db.add_column('index_instance', 'virtualenv',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['index.Virtualenv'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Virtualenv.instance'
        db.delete_column('index_virtualenv', 'instance_id')


    def backwards(self, orm):
        # Deleting field 'Instance.virtualenv'
        db.delete_column('index_instance', 'virtualenv_id')


        # User chose to not deal with backwards NULL issues for 'Virtualenv.instance'
        raise RuntimeError("Cannot reverse this migration. 'Virtualenv.instance' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Virtualenv.instance'
        db.add_column('index_virtualenv', 'instance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['index.Instance']),
                      keep_default=False)
