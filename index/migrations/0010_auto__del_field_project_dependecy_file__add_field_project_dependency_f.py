...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.dependecy_file'
        db.delete_column('index_project', 'dependecy_file')

        # Adding field 'Project.dependency_file'
        db.add_column('index_project', 'dependency_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.dependecy_file'
        db.add_column('index_project', 'dependecy_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Project.dependency_file'
        db.delete_column('index_project', 'dependency_file')
