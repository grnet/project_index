...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('notes_note', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['index.Project']))

    def backwards(self, orm):

        # Changing field 'Note.project'
        db.alter_column('notes_note', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['index.Project'], null=True))
